...
for (var i = 0; i < table1.getCounter(); i++) {
	...
	var s1 = table1.getValue("slice", i);
...
var sMin = table1.getValue("slice", 0);
var sMax = table1.getValue("slice", 0);

for (var i = 0; i < table1.getCounter(); i++) {
	var x = table1.getValue("x", i);
	var y = table1.getValue("y", i);
	var s = table1.getValue("slice", i);
...
for (var i = 0; i < table1.getCounter(); i++) {
	var x = table1.getValue("x", i);
	var y = table1.getValue("y", i);
	var s = (table1.getValue("slice", i) - sMin) + 1;
