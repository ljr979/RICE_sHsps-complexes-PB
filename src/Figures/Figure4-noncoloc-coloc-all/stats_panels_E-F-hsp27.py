"""this script performs two-way anova on the molecule size data in Figure 4, and Supp Figure 4. This compares between colocalised and non-colocalised molecules, and between all timepoints. These were then annotated in the figures.
